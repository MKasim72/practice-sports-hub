...
document.addEventListener('DOMContentLoaded', () => {
    const selectedProduct = JSON.parse(window.localStorage.getItem('add_cart'));
        ...
        <div class="row d-flex justify-content-center my-4">
          <div class="col-md-8">
            <div class="card mb-4">
              ...
              <div class="card-body" style="background-color: black;background-image: radial-gradient(black 10px,red 10px);background-size: 15px 15px;">
                <!-- Single item -->
                <div class="row">
                  <div class="col-lg-3 col-md-12 mb-4 mb-lg-0">
                    <!-- Image -->
                    <div class="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                    <img src="${'images/'+selectedProduct.image}" alt="${selectedProduct.name}" width="190px" id="cart_img">
                      <a href="#!">
                  ...
                  <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
                    <!-- Data -->
                    <p class="text-light"><strong>${selectedProduct.name}</strong></p>
                  ...
                  <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                    ...
                    <div class="d-flex mb-4" style="max-width: 300px">
                      ...
                      <button class="btn btn-primary px-3 ms-2"
                        onclick="prod_delete(${selectedProduct.id})">
                    ...
                    <p class="text-start text-md-center">
                      <strong class="text-light">${selectedProduct.price}</strong>
                    </p>
                    <!-- Price -->
                  </div>
                </div>
